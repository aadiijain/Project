<!-- INSERT INTO `recipient`(`ID`, `FirstName`, `LastName`, `MobileNum`, `Email`, `Stem_type_R`) VALUES ('[value-1]','[value-2]','[value-3]','[value-4]','[value-5]','[value-6]') -->
<?php
session_start();
require "config.php";
...
if ($_SERVER['REQUEST_METHOD']=="POST"){
    ...
    $query = "SELECT * FROM `stemcell_db`.`recipient` WHERE `Email`='$email'";
    ...
    <body>
        ...
        <center>
            <div class="rloginform">
                <p style="font-size: 45px;">Please Login(Recipient)</p>
            ...
            <p>Don't have an account? 
                <a href="recp_signup.php"> Click Here</a></p>
            <br><br><br>
            </center>
    </body>
</html>